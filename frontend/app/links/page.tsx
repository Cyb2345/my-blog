...
export default async function LinksPage() {
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-10">
      <p className="text-sm font-bold text-primary">Friends</p>
      <h1 className="mt-2 text-3xl font-black text-foreground">友链</h1>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0">
                <h2 className="flex items-center gap-2 text-lg font-black text-foreground group-hover:text-primary">
                  {link.name}
